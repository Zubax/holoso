...
checks that div0 itself is correct. Same y_sgnop-stability constraint as the other arithmetic wrappers applies.
"""
...
async def holoso_fdiv_cocotb(dut) -> None:
    ...
    sb = PipelineScoreboard(dut, [("y", "y"), ("div0", "div0")])
    ...
    # Random bulk grouped by y_sgnop.
