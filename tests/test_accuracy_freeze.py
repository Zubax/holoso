...
_BASELINE: dict[str, dict[str, tuple[float, float]]] = {
    ...
    # The scaling is exact, so these lanes sit where the pairwise sum of squares leaves them rather than above a
    # written `sqrt(x @ x)`: a reassociation, not a loss.
    "imu_fusion-e8m36": {
        "out_0_0": (3.47, 0.636),
        "out_0_1": (1.56, 0.541),
        "out_0_2": (2.15, 0.642),
        "state_attitude_0": (1.12, 0.516),
        "state_attitude_1": (0.7, 0.295),
        "state_attitude_2": (0.75, 0.412),
        "state_attitude_3": (1.59, 0.683),
    ...
    "imu_fusion-e8m36-ffma": {
        ...
        "out_0_1": (1.96, 0.793),
        "out_0_2": (1.85, 0.659),
        "state_attitude_0": (1.12, 0.456),
        "state_attitude_1": (0.7, 0.253),
        "state_attitude_2": (0.74, 0.266),
        "state_attitude_3": (1.84, 0.882),
        "state_bias_0": (0.16, 0.159),
        "state_bias_1": (0.16, 0.159),
        "state_bias_2": (0.16, 0.159),
    },
    "imu_fusion-e6m18": {
        ...
        "out_0_1": (3.05, 1.045),
        "out_0_2": (1.76, 0.766),
        "state_attitude_0": (1.31, 0.658),
        "state_attitude_1": (1.21, 0.663),
        "state_attitude_2": (1.26, 0.513),
        "state_attitude_3": (0.91, 0.551),
    ...
    "imu_fusion-e6m18-ffma": {
        ...
        "out_0_1": (1.17, 0.625),
        "out_0_2": (3.15, 0.983),
        "state_attitude_0": (1.15, 0.47),
        "state_attitude_1": (1.21, 0.609),
        "state_attitude_2": (0.66, 0.309),
        "state_attitude_3": (0.73, 0.424),
        "state_bias_0": (0.27, 0.257),
        "state_bias_1": (0.27, 0.257),
        "state_bias_2": (0.27, 0.257),
    },
    # No sum is computed as a multiple of another, so the two covariance sums round independently.
    "ekf1_stateful-e8m36": {
        "state_P_urt_0": (8.35, 4.183),
        "state_P_urt_1": (2.98, 1.121),
        "state_P_urt_2": (11.42, 5.687),
        "state_P_urt_3": (3.99, 1.97),
        "state_P_urt_4": (9.42, 4.307),
        "state_P_urt_5": (8.06, 5.263),
        "state_x_0": (3.52, 1.522),
        "state_x_1": (2.99, 1.364),
        "state_x_2": (3.27, 1.521),
    },
    "ekf1_stateful-e8m36-ffma": {
        "state_P_urt_0": (8.35, 4.183),
        "state_P_urt_1": (2.23, 0.853),
        "state_P_urt_2": (12.05, 5.854),
        "state_P_urt_3": (3.99, 1.97),
        "state_P_urt_4": (8.54, 3.885),
        "state_P_urt_5": (8.06, 5.263),
        "state_x_0": (3.09, 1.253),
        "state_x_1": (3.59, 1.406),
        "state_x_2": (3.33, 1.324),
    },
    ...
    # A shared sign chain is owned by the fma planner, so three more additions contract here.
    "foc-e8m36-ffma": {
        "out_0_0": (3.9, 0.697),
        "out_0_1": (4.17, 1.045),
        "out_0_2": (3.92, 0.897),
